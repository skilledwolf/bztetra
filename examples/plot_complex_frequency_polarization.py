...
DEFAULT_OUTPUT = Path("build/review_plots/complex_frequency_polarization_matsubara.png")
GRID_SHAPE = (16, 16, 16)
...
def build_figure(weighted_curve: np.ndarray, exact_channels: np.ndarray):
    ...
    figure.suptitle(r"Free-Electron Complex-Frequency Polarization on the Imaginary-Frequency Axis")
    axes[0].annotate(
