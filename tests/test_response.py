...
from tests.legacy_cases import legacy_8x8_nesting_function_weighted_integrals
from tests.legacy_cases import legacy_8x8_phase_space_overlap_weighted_integrals
